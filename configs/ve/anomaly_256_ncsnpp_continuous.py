...
def get_config():
  ...
  # data.path = '/data/tai/phd/data/mvtec'  # Magic
  # data.path = '/home/data/tai/phd/data/mvtec'  # Hercules
  # data.dataset = 'FFHQ'
  # data.tfrecords_path = '/data/datasets/ffhq/ffhq-r08.tfrecords'
